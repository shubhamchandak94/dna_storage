...
for sync in sync_list:
    for BCH_bits in [1,2,3,4]:
        for del_prob in del_prob_list:
            ...
            min_coverage = util.find_min_coverage(file_name,oligo_length,BCH_bits,LDPC_alpha,ldpc_code_prefix,bin_index_len,file_size,sub_prob,sub_prob,num_trials,ins_prob = ins_prob, del_prob = del_prob, start_coverage = 2.2, sync = sync, sync_pos=sync_pos,frac_random_reads=frac_random_reads, max_bitflips_indel=1)
